...
class DigestChallenge extends Object {
    ...
    private static final int CIPHER_RECOGNIZED_MASK = CIPHER_3DES | CIPHER_DES | CIPHER_RC4_40 | CIPHER_RC4 | CIPHER_RC4_56;
    ...
    void handleAlgorithm(ParsedDirective pd) throws SaslException {
        ...
        if (!"md5-sess".equals(m_algorithm))
            throw new SaslException("Invalid algorithm directive value: " + m_algorithm);
    }
