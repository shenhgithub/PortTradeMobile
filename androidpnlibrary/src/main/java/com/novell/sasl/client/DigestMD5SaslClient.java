...
public class DigestMD5SaslClient implements SaslClient {
    ...
    private String createDigestResponse(byte[] challenge) throws SaslException {
        ...
        if (realmSize == 0) {
            ...
            callbacks[0] = new RealmChoiceCallback("Realm", (String[]) realms.toArray(new String[realmSize]), 0,      //the default choice index
    ...
    boolean checkServerResponseAuth(byte[] serverResponse) throws SaslException {
        ...
        response = DigestCalcResponse(m_HA1, m_dc.getNonce(), "00000001", m_clientNonce, m_qopValue, DIGEST_METHOD, m_digestURI, false);
