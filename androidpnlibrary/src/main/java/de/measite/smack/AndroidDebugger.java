    ...
    private void createDebug() {
        ...
        readerListener = new ReaderListener() {
            public void read(String str) {
                Log.d("SMACK", dateFormatter.format(new Date()) + " RCV  (" + connection.hashCode() +
                                "): " +
                                str);
            }
        };
        ...
        writerListener = new WriterListener() {
            public void write(String str) {
                Log.d("SMACK", dateFormatter.format(new Date()) + " SENT (" + connection.hashCode() +
                                "): " +
                                str);
            }
        };
        ...
        listener = new PacketListener() {
            public void processPacket(Packet packet) {
                if (printInterpreted) {
                    Log.d("SMACK", dateFormatter.format(new Date()) + " RCV PKT (" +
                                    connection.hashCode() +
                                    "): " +
                                    packet.toXML());
                }
        ...
        connListener = new ConnectionListener() {
            public void connectionClosed() {
                Log.d("SMACK", dateFormatter.format(new Date()) + " Connection closed (" +
                                connection.hashCode() +
                                ")");
            }
            ...
            public void reconnectionSuccessful() {
                Log.d("SMACK", dateFormatter.format(new Date()) + " Connection reconnected (" +
                                connection.hashCode() +
                                ")");
            }

            public void reconnectingIn(int seconds) {
                Log.d("SMACK", dateFormatter.format(new Date()) + " Connection (" +
                                connection.hashCode() +
