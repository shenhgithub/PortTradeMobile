...
public final class Address {
     ...
     *
     * @throws java.net.UnknownHostException The hostname does not have any addresses
     */
     ...
     *
     * @throws java.net.UnknownHostException The address is not a valid IP address.
     */
     ...
     * @return The IP addresses
     *
     * @throws java.net.UnknownHostException The address is not a valid IP address in
     ...
     *
     * @throws java.net.UnknownHostException There is no hostname for the address
     */
