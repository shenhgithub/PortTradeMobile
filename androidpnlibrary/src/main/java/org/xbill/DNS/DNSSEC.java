...
public class DNSSEC {
     ...
     *
     * @throws org.xbill.DNS.DNSSEC.UnsupportedAlgorithmException  The algorithm is unknown
     * @throws org.xbill.DNS.DNSSEC.MalformedKeyException          The key is malformed
     * @throws org.xbill.DNS.DNSSEC.KeyMismatchException           The key and signature do not match
     * @throws org.xbill.DNS.DNSSEC.SignatureExpiredException      The signature has expired
     * @throws org.xbill.DNS.DNSSEC.SignatureNotYetValidException  The signature is not yet valid
     * @throws org.xbill.DNS.DNSSEC.SignatureVerificationException The signature does not verify.
     * @throws org.xbill.DNS.DNSSEC.DNSSECException                Some other error occurred.
     */
