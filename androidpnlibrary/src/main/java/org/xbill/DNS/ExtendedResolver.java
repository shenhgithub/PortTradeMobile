...
public class ExtendedResolver implements Resolver {
     ...
     * initialized.
     *
     * @throws java.net.UnknownHostException Failure occured initializing SimpleResolvers
     * @see SimpleResolver
     * @see ResolverConfig
     */
     ...
     * @return The response.
     *
     * @throws java.io.IOException An error occurred while sending or receiving.
     */
