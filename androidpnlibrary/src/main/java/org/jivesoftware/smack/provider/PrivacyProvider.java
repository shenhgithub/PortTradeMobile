...
/**
 * The PrivacyProvider parses {@link org.jivesoftware.smack.packet.Privacy} packets. {@link org.jivesoftware.smack.packet.Privacy}
 * Parses the <tt>query</tt> sub-document and creates an instance of {@link org.jivesoftware.smack.packet.Privacy}.
 * For each <tt>item</tt> in the <tt>list</tt> element, it creates an instance
 * of {@link org.jivesoftware.smack.packet.PrivacyItem} and {@link org.jivesoftware.smack.packet.PrivacyItem.PrivacyRule}.
 *
