 ...
 */
class PacketWriter {
    private static final String LOG_TAG = LogUtil.makeLogTag(PacketWriter.class);
     ...
     *
     * @throws java.io.IOException If an error occurs while sending the stanza to the server.
     */
