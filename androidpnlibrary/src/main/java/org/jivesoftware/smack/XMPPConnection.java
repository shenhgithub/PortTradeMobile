...
public class XMPPConnection extends Connection {
    private static final String LOG_TAG = LogUtil.makeLogTag(XMPPConnection.class);
    ...
    /**
     * Creates a new XMPP conection in the same way {@link #XMPPConnection(String , org.apache.harmony.javax.security.auth.callback.CallbackHandler)} does, but
    ...
    /**
     * Creates a new XMPP conection in the same way {@link #XMPPConnection(ConnectionConfiguration , org.apache.harmony.javax.security.auth.callback.CallbackHandler)} does, but
     * with no callback handler for password prompting of the keystore.  This will work
     * in most cases, provided the client is not required to provide a certificate to
     * the server.
     *
     ...
     *
     * @deprecated replaced by {@link Connection#addPacketInterceptor(PacketInterceptor , org.jivesoftware.smack.filter.PacketFilter)}.
     */
     ...
     * @param packetFilter   the packet filter to use.
     *
     * @deprecated replaced by {@link #addPacketSendingListener(PacketListener , org.jivesoftware.smack.filter.PacketFilter)}.
     */
