 ...
 * <li>{@link org.jivesoftware.smack.Roster.SubscriptionMode#accept_all accept_all} -- accept all subscription requests.</li>
 * <li>{@link org.jivesoftware.smack.Roster.SubscriptionMode#reject_all reject_all} -- reject all subscription requests.</li>
 * <li>{@link org.jivesoftware.smack.Roster.SubscriptionMode#manual manual} -- manually process all subscription requests.</li>
 * </ul>
 *
 * @author Matt Tucker
...
public class Roster {
     ...
     * is {@link org.jivesoftware.smack.Roster.SubscriptionMode#accept_all}.
     *
     ...
     * The default subscription mode is {@link org.jivesoftware.smack.Roster.SubscriptionMode#accept_all}.<p>
    ...
    private void insertRosterItem(RosterPacket.Item item, Collection<String> addedEntries, Collection<String> updatedEntries, Collection<String> deletedEntries) {
        RosterEntry entry = new RosterEntry(item.getUser(), item.getName(), item.getItemType(), item.getItemStatus(), this, connection);
