 ...
 * <li>{@link #authenticate(String , String , org.apache.harmony.javax.security.auth.callback.CallbackHandler)} -- Initiate authentication stanza
...
public abstract class SASLMechanism implements CallbackHandler {
     ...
     *
     * @throws java.io.IOException If a network error occures while authenticating.
     * @throws XMPPException       If a protocol error occurs or the user is not authenticated.
     */
