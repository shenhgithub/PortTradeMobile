...
public class PrivacyListManager {
    ...
    /**
     * Send the {@link org.jivesoftware.smack.packet.Privacy} packet to the server in order to know some privacy content and then
     * waits for the answer.
     *
     * @param requestPrivacy is the {@link org.jivesoftware.smack.packet.Privacy} packet configured properly whose XML
     *                       will be sent to the server.
     *
     * @return a new {@link org.jivesoftware.smack.packet.Privacy} with the data received from the server.
     *
    ...
    /**
     * Send the {@link org.jivesoftware.smack.packet.Privacy} packet to the server in order to modify the server privacy and
     * waits for the answer.
     *
     * @param requestPrivacy is the {@link org.jivesoftware.smack.packet.Privacy} packet configured properly whose xml will be sent
     *                       to the server.
     *
     * @return a new {@link org.jivesoftware.smack.packet.Privacy} with the data received from the server.
     *
    ...
    /**
     * Answer a privacy containing the list structre without {@link org.jivesoftware.smack.packet.PrivacyItem}.
     *
