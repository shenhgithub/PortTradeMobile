...
public abstract class Packet {
    ...
    protected static final String DEFAULT_LANGUAGE = java.util.Locale.getDefault().getLanguage().toLowerCase();
     ...
     * {@link org.jivesoftware.smack.util.StringUtils#parseBareAddress(String) bare address},
     * {@link org.jivesoftware.smack.util.StringUtils#parseName(String) user name},
     * {@link org.jivesoftware.smack.util.StringUtils#parseServer(String) server}, and
     * {@link org.jivesoftware.smack.util.StringUtils#parseResource(String) resource}.
     *
    ...
    public boolean equals(Object o) {
        ...
        if (properties != null ? !properties.equals(packet.properties) : packet.properties != null) {
            return false;
        }
